...
define('BASEPATH'     , IS_LOCAL ? '/formacion/Sistema-de-likes-Base/' : '/'); // Debe ser cambiada a la ruta de tu proyecto en producción y desarrollo
